#!/usr/bin/env python
# filepath: /Users/ankitku5/Desktop/Data_seicene_college_project/eval/run_evaluation.py
...
# Now import from the eval package
from eval.constants.paths import DEFAULT_REFERENCE_PATH, DEFAULT_PREDICTION_PATH
