#!/usr/bin/env python
"""Evaluation script for Student Chat responses.

This script:
1. Loads the transcript data 
2. Calls the student chat generation function
3. Saves the generated student chat responses
...
from evaluation.generate_output.generate_student_chat import generate_student_chat_responses, load_transcript, SAMPLE_QUERIES
...
class StudentChatEvaluator:
    """Evaluator for Student Chat responses."""
    ...
    def __init__(self, transcript_path: str = None, ground_truth_path: str = None):
        ...
        Args:
            ...
            ground_truth_path: Path to the ground truth student chat responses
        """
        # Set default paths if not provided
        self.transcript_path = transcript_path or '/Users/ankitku5/Desktop/vid2insight/docs/transcript.json'
        self.ground_truth_path = ground_truth_path or '/Users/ankitku5/Desktop/vid2insight/evaluation/ground_truth/Student_chat.txt'
        self.output_path = '/Users/ankitku5/Desktop/vid2insight/evaluation/model_outputs/model_generated_student_chat.txt'
        self.eval_results_dir = '/Users/ankitku5/Desktop/vid2insight/eval_results'
        self.report_path = '/Users/ankitku5/Desktop/vid2insight/evaluation/reports/student_chat_evaluation_report.md'
        
        # Ensure eval_results_dir exists
        os.makedirs(self.eval_results_dir, exist_ok=True)
    
    def generate_responses(self):
        """Generate model responses for student chat queries."""
        ...
        logger.info("Generating student chat responses...")
        responses = generate_student_chat_responses(transcript_data, self.output_path)
        if not responses:
            logger.error("Failed to generate student chat responses.")
            return False
    ...
    def load_generated_responses(self):
        ...
        try:
            ...
            for qa in qa_pairs:
                ...
                parts = re.split(r'\n\nA: ', qa, maxsplit=1)
                if len(parts) == 2:
                    # Extract the response and remove separator lines
    ...
    def load_ground_truth(self):
        ...
        try:
            ...
            # Parse the Q&A format to extract just the answers
            qa_pairs = re.split(r'Q: ', content)
            responses = []
    ...
    def run_evaluation(self):
        ...
        logger.info("Starting student chat evaluation...")
        ...
        print("\n===== EVALUATION RESULTS FOR STUDENT CHAT =====")
        # Print BERT Score
    ...
    def _generate_report(self, metrics_results, generated_responses):
        ...
        try:
            ...
            # Show the first 3 generated responses compared to ground truth
...
if __name__ == "__main__":
    evaluator = StudentChatEvaluator()
