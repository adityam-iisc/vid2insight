...
from evaluation.constants.paths import DEFAULT_REFERENCE_PATH, DEFAULT_PREDICTION_PATH, BLEU_RESULTS_PATH
from evaluation.config.model_config import BLEU_CONFIG
